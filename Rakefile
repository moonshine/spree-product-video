...
desc 'Generate documentation for the product_video extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'ProductVideoExtension'
...
desc 'Test the product_video extension.'
...
namespace :test do
  desc 'Functional test the product_video extension.'
  ...
  desc 'Unit test the product_video extension.'
